...
const InterviewCard = ({inter}) => {
  ...
  return (
    <div className='py-3 px-10 w-[30vw] border shadow-sm rounded-lg'>
               ...
               <h2 className='font-bold text-primary text-xl'>{inter?.jobPosition} role in job</h2>
               <h2 className=' text-gray-600 text-sm mt-3'>{inter?.jobExp} years of Experience</h2>
               <h2 className=' text-gray-500 text-sm mt-1'>Created At :{inter?.createdAt} </h2>
