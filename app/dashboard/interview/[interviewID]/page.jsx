  ...
  return intData&&(
    ...
    <div className=''>
               ...
               <div className='pt-7'>
                              ...
                              <h2 className='text-sm mt-2'><strong>Job Role/Job Position: </strong>{intData.jobPosition}</h2>
                              <h2 className='text-sm mt-4'><strong>Job Description/Tech Stack: </strong>{intData.jobDesc}</h2>
                              <h2 className='text-sm mt-4'><strong>Years of Experience: </strong>{intData.jobExp}</h2>
                              </div>
